...
function printCar(car: {
  ...
  if (typeof car.chargeVoltage === 'number')
    console.log(`Charge voltage: ${car.chargeVoltage}v`)
}
...
// Spread operator
printCar({ ...myarg }) // Works with spread operator

//* Index signatures

//? Dictionary of phone #s
const phones: {
  [k: string]: { country: string; area: string; number: string } | undefined
} = {
